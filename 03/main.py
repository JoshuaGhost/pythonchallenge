...
for i in range(len(data)-4):
    if i > 3:
        if data[i+4].islower() and data[i-4].islower() and data[i-1].isupper() and data[i-2].isupper() and data[i-3].isupper() and data[i+1].isupper() and data[i+2].isupper() and data[i+3].isupper() and data[i].islower():
            output += data[i]
print(output)
